...
//	
//	Module Name:	XUIVerticalSlider.h
//	Author:			Lynn Duke
...
#ifndef __X_UI_VERTICAL_SLIDER_H__
#define __X_UI_VERTICAL_SLIDER_H__




//*****************************************************************************
//! Vertical slider control representing a numerical range from 0 to 100%.
/**
The XUIVerticalSlider object provides a graphical representation of a numerical range
...
*/
//*****************************************************************************
class XUIVerticalSlider : public XUIElement
{
protected:
	...
	XU8			m_sliderState;
	XU32		m_nativeKnobHeight;
	XU32		m_scaledKnobHeight;
