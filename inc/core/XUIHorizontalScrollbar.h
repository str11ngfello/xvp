...
//	
//	Module Name:	XUIHorizontalScrollbar.h
//	Author:			Lynn Duke
...
#ifndef __X_UI_HORIZONTAL_SCROLLBAR_H__
#define __X_UI_HORIZONTAL_SCROLLBAR_H__
...
//*****************************************************************************
//*****************************************************************************
class XUIHorizontalScrollbar : public XUIElement
{
protected:
	XUIButton				m_scrollForwardButton;
	XUIButton				m_scrollBackButton;
	XUIHorizontalSlider		m_slider;
	XU32					m_maxSteps;
	XU32					m_currentStep;
	XU32					m_prevStep;
...
public:
	...
	//*****************************************************************************
	XUIHorizontalScrollbar();
	virtual ~XUIHorizontalScrollbar();
