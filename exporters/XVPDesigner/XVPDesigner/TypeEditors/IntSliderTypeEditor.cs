...
{
	public class IntSliderTypeEditor : System.Drawing.Design.UITypeEditor
	{
		private IWindowsFormsEditorService edSvc;
		private IntSliderEditor editor = new IntSliderEditor();
		...
		public override object EditValue(System.ComponentModel.ITypeDescriptorContext context,System.IServiceProvider provider,object value)
		{
			...
			if (edSvc != null)
			{
				editor.Value = Convert.ToInt32(Program.g_mainForm.ActivePropertyExplorer.SelectedGridItem.PropertyDescriptor.GetValue(Program.g_mainForm.ActivePropertyExplorer.SelectedObject));
				...
				foreach (Attribute a in Program.g_mainForm.ActivePropertyExplorer.SelectedGridItem.PropertyDescriptor.Attributes)
				{
					...
					if (range != null)
					{
						editor.MinValue = Convert.ToInt32(range.MinValue);
						editor.MaxValue = Convert.ToInt32(range.MaxValue);
