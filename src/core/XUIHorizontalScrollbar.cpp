...
//	
//	Module Name:	XUIHorizontalScrollbar.cpp
//	Author:			Lynn Duke
...
//*****************************************************************************
//*****************************************************************************
XUIHorizontalScrollbar::XUIHorizontalScrollbar()
{
	m_maxSteps = 1;
	m_currentStep = 0;
	m_prevStep = 0;
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::init(XUserInterface* pParentUI,XU32 zOrder,XRect& sliderScreenRect,
						  ...
						  XRect& forwardButtonScreenRect,XS8* pTemplateFile)
{
	...
	else
	{
		...
		m_slider.setPercentage((float)m_currentStep/(float)m_maxSteps);
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::destroy()
{
	m_slider.destroy();
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::update(XF32 dt)
{
	//Only if the scrollbar is sliding do we want to modify the current step.
	if (m_slider.isSliding())
	{
		m_currentStep = (XU32)(m_slider.getPercentage() * (XF32)m_maxSteps);
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::render()
{
	return X_OK;
}
...
//*****************************************************************************
//*****************************************************************************
/*XStatus XUIHorizontalScrollbar::eventNotify(X_UI_EVENT_TYPE eventType,void* pEventData)
{
...
//*****************************************************************************
//*****************************************************************************
XU32 XUIHorizontalScrollbar::getStep()
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setStep(XU32 step)
{
	if (step <= m_maxSteps)
	{
		m_currentStep = step;
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setMaxSteps(XU32 maxSteps)
{
	if (maxSteps != 0)
	{
		m_maxSteps = maxSteps;
...
//*****************************************************************************
//*****************************************************************************
XU32 XUIHorizontalScrollbar::getMaxSteps()
{
	return m_maxSteps;
}
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::incrementStep()
{
	++m_currentStep;
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::decrementStep()
{
	if (m_currentStep != 0)
	{
		--m_currentStep;
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setZOrderOffset(XU32 zOrder)
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::show()
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::hide()
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::enable()
{
	m_scrollBackButton.enable();
	m_scrollForwardButton.enable();
	m_slider.enable();
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::disable()
{
	m_scrollBackButton.disable();
	m_scrollForwardButton.disable();
	m_slider.disable();
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setOpacity(XF32 opacity)
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::move(XVector2D& moveVector)
{
	XRect r;
...
//*****************************************************************************
//*****************************************************************************
XBOOL XUIHorizontalScrollbar::isPointInside(XVector2D& point)
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::onMouseDownRepeat(XVector2D& hotSpot,X_MOUSE_BUTTON button,
										  XUIElement* pChildElement)
{
	//Depending on which button was pressed, increment or decrement the step.
	if (pChildElement == &m_scrollBackButton)
		decrementStep();
	else if (pChildElement == &m_scrollForwardButton)
		incrementStep();
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setNativePosition(XVector2D& position)
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XUIHorizontalScrollbar::setToolTipText(XS8* pToolTipText)
{
...
//*****************************************************************************
//*****************************************************************************
XS8* XUIHorizontalScrollbar::getToolTipText()
{
