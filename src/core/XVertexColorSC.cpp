...
//	
//	Module Name:	XVertexColorSC.cpp
//	Author:			Lynn Duke
...
//*****************************************************************************
//*****************************************************************************
XStatus XVertexColorSC::init(XS8* pShaderName)
{
	//Create vertex and pixel shaders necessary for rendering particle systems.
	XStatus status = X_OK;
	
	status = XVP::GraphicsMgr.createVertexShader("Vertex Color.fx","mainVS",m_vsHandle);
	if (status == X_OK)
	{
		status = XVP::GraphicsMgr.createPixelShader("Vertex Color.fx","mainPS",m_psHandle);
		m_inited = true;
	}
...
//*****************************************************************************
//*****************************************************************************
XStatus XVertexColorSC::destroy()
{
...
//*****************************************************************************
//*****************************************************************************
XStatus XVertexColorSC::render(XRenderEvent* pRenderEvent)
{
	//Set shaders
